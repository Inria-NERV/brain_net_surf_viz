function h = my_simpleBrainSurfaceHemisphere_cData_colorNoMotif_noShade(range  , centerPatch , alphaBrain , hemisphere , nodeColors )
...
vertexColorFinal = vertexColor ;%+ shading_colorHem;
